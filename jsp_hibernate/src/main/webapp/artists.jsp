<%@ page import="ssau.lr8.model.Artist" %>
<%@ page import="java.util.List" %>
<%@ page import="ssau.lr8.dao.util.DaoFactory" %>
        ...
        <div class="d-flex flex-row flex-wrap gap-2 m-3">
            ...
            <div class="card card-form" id="artist-<%= artist.getId() %>">
                <div class="card-body">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right"
                                ...
                                <li><a class="dropdown-item"
                                       href="artists?action=showAlbums&artistId=<%= artist.getId() %>">Показать альбомы</a></li>
                    ...
                    <p class="card-text">ID: <%=artist.getId()%>
                    </p>
                </div>
            </div>
            <%}%>
